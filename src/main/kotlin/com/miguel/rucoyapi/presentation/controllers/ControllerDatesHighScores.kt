...
class ControllerDatesHighScores {
    ...
    suspend fun dates(@PathVariable type:String): ResponseEntity<*> {
        return try {
    ...
    suspend fun datesFindByYears(@PathVariable type: String, @PathVariable year: String): ResponseEntity<*> {
        return try {
    ...
    suspend fun datesFindByMonth(@PathVariable type: String, @PathVariable month: String): ResponseEntity<*> {
        return try {
