...
class RepositoryTopsImpl(
    ...
    override suspend fun melee(page: Int, size: Int, id:String): Turso? {
        TODO("Not yet implemented")
    }

    override suspend fun distance(page: Int, size: Int, id:String): Turso? {
        TODO("Not yet implemented")
    }

    override suspend fun magic(page: Int, size: Int, id:String): Turso? {
        TODO("Not yet implemented")
    }

    override suspend fun defense(page: Int, size: Int, id:String): Turso? {
        TODO("Not yet implemented")
    }
